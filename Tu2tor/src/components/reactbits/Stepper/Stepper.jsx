...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full rounded-2xl shadow-2xl ${stepCircleContainerClassName}`}
      >
              ...
              <React.Fragment key={stepNumber}>
                {renderStepIndicator ? (
                  ...
                  <StepIndicator
                    ...
                    onClickStep={(clicked) => {
                      // Optional: Prevent clicking future steps if validation is needed
          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            <div className={`mt-10 flex ${currentStep !== 1 ? 'justify-between' : 'justify-end'}`}>
              ...
              <button
                ...
                className="duration-350 flex items-center justify-center rounded-full bg-blue-600 py-1.5 px-3.5 font-medium tracking-tight text-white transition hover:bg-blue-500 active:bg-blue-700"
                {...nextButtonProps}
              >
...
function StepConnector({ isComplete }) {
  ...
  return (
    <div className="relative mx-2 h-0.5 flex-1 overflow-hidden rounded bg-gray-700">
      <motion.div
